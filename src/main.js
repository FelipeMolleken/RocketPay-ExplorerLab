...
const cartaoColor1 = document.querySelector(".cc-bg svg > g g:nth-child(1) path")
const cartaoColor2 = document.querySelector(".cc-bg svg > g g:nth-child(2) path")
...
function setCardType(type) {
  ...
  cartaoColor1.setAttribute("fill", colors[type][0])
  cartaoColor2.setAttribute("fill", colors[type][1])
...
cardHolder.addEventListener("input", () => {
  ...
  ccHolder.innerText = cardHolder.value.length === 0 ? "FELIPE GOIS MOLLEKEN" : cardHolder.value
})
